...
export function registerCourseReviews() {
	wp.blocks.registerBlockType('masteriyo/course-reviews', {
		title: __('Course Reviews', 'masteriyo'),
		description: __(
		...
		icon: <Icon type="blockIcon" name="course-reviews" size={24} />,
		category: 'masteriyo-single-course',
		keywords: ['Course Reviews'],
		attributes,
		supports: {
			align: false,
			html: false,
