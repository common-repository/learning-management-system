...
export function registerCourseContents() {
	wp.blocks.registerBlockType('masteriyo/course-contents', {
		title: __('Course Content', 'masteriyo'),
		description: __(
		...
		icon: <Icon type="blockIcon" name="course-contents" size={24} />,
