...
export function registerCoursesAuthorBlock() {
	wp.blocks.registerBlockType('masteriyo/course-author', {
		title: 'Course Author',
		description: __(
		...
		icon: <Icon type="blockIcon" name="course-author" size={24} />,
		category: 'masteriyo-single-course',
		keywords: ['Courses Author Block'],
		attributes,
		supports: {
			align: false,
			html: false,
