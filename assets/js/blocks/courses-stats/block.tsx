...
export function registerCourseStatsBlock() {
	wp.blocks.registerBlockType('masteriyo/course-stats', {
		title: 'Course Stats',
		description: __(
		...
		icon: <Icon type="blockIcon" name="single-course-stats" size={24} />,
		category: 'masteriyo-single-course',
		keywords: ['Course Stats Block'],
		attributes,
		supports: {
			align: false,
			html: false,
